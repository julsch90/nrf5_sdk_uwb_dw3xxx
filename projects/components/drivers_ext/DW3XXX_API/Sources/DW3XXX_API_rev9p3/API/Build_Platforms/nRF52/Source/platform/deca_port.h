...
//This set the IO (WAKEUP) for waking up the chip
...
//This set the IO (CS) for waking up the chip
#define SET_CS_PIN_IO_LOW       nrf_gpio_pin_clear(DW3000_CS_Pin)
#define SET_CS_PIN_IO_HIGH      nrf_gpio_pin_set(DW3000_CS_Pin)
