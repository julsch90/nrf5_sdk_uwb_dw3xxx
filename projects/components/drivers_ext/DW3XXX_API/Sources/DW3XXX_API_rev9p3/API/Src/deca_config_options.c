...
#ifdef UWB_CONFIG_OPTION_CH9
/* Channel 9, PRF 64M, Preamble Length 128, PAC 8, Preamble code 10, Data Rate 6.8M, No STS
 */
dwt_config_t config_options = {
    9,                  /* Channel number. */
    DWT_PLEN_128,       /* Preamble length. Used in TX only. */
...
#ifdef UWB_CONFIG_OPTION_CH5_STS_SP1
...
#ifdef UWB_CONFIG_OPTION_CH9_STS_SP1
