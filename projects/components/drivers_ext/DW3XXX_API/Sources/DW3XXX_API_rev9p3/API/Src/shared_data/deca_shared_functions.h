#ifndef _DECA_SHARED_FUNC_
#define _DECA_SHARED_FUNC_
...
#define dw_dwt_usecs_to_usecs(_t)       (float)( (_t) * (0x10000UL/(128*499.2)))
#define dw_usecs_to_dwt_usecs(_t)       (float)( (_t) / dw_dwt_usecs_to_usecs(1.0))
