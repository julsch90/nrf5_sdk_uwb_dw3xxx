...
def thread_read_data(arg, update_plot_data):
    ...
    while True:
        ...
        # receiving packet should match the size of 2084 (packet size)
        if len(data_buffer) != 2084:
            # read empty
            ser.read(5000)
            continue
        ...
        data_packet = parse_data_packet(data_buffer)
        ...
        # print(diag_packet["rx_timestamp_ms"])
